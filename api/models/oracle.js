...
class OracleModels {
  ...
  static async createEmployeesTable(connection) {
    ...
    if (exists) {
      console.log('📊 Tabla employees ya existe');
      return;
    }
  ...
  static async createFinancialRecordsTable(connection) {
    ...
    if (exists) {
      console.log('📊 Tabla financial_records ya existe');
      return;
    }
    ...
    `;
    await connection.execute(query);
    console.log('✅ Tabla financial_records creada');
  }
  ...
  static async createInventoryTable(connection) {
    ...
    if (exists) {
      console.log('📊 Tabla inventory ya existe');
      return;
    }
  ...
  static async createReportsTable(connection) {
    ...
    if (exists) {
      console.log('📊 Tabla corporate_reports ya existe');
      return;
    }
  ...
  static async createCorporateClientsTable(connection) {
    ...
    `;
    await connection.execute(query);
    console.log('✅ Tabla corporate_clients creada');
  }
